...
export default {
  ...
  // Table #1 Td
  table_1_td_1: ['1', '订单创建后，买方主动取消订单，或者因付款超时而系统自动取消订单。', '当日达到4次，系统将限制买方买入功能；连续2日触发，系统将进一步限制买方账户部分功能。'],
  table_1_td_2: ['2', '未付款的情况下，点击“我已付款', '卖方有权要求取消此笔订单，买方当日被投诉达到2次，系统将限制买方账户部分功能；此类投诉单笔金额超过8万人民币的，系统将直接限制买方账户48小时。'],
  table_1_td_3: ['3', '卖方无违规，买方未付款的情况下，无故点击“申诉”。', '卖方有权要求取消此笔订单，买方当日被投诉达到2次，系统将限制买方账户部分功能；'],
  table_1_td_4: ['4', '未按照卖方订单详情页面显示的收款账户进行付款。', '卖家有权要求取消订单，数字资产归还给卖方，买方自行承担转错款的风险。'],
  table_1_td_5: [
    '5',
  ...
  table_2_td_2: ['2', '订单生成后，对订单价格有异议的。', '除经买方同意协商订单价格外，订单正常成交，卖方应在订单规定时间内放行。'],
  table_2_td_3: [
    '3',
    '卖方所提供的收款账户出现异常。 ',
  ...
  table_2_td_6: ['6', '卖方收取买方非平台实名一致的账户付款，未拒绝成交的。', '1）由此引发的风险，由卖方自行承担。2）因此而被投诉的，系统将限制卖方账户部分功能。'],
  table_2_td_7: [
    '7',
  ...
  table_2_ps: '注：OTC交易使用三方电话系统过程中如您主动挑起语言冲突，有辱骂、嘲讽或其他语言过激行为等情况，系统将限制您账户部分功能。',
  ...
  table_3_td_4: ['4', '利用平台其他用户测卡：用户在订单未发生的情况下向平台其他用户小额打款，且无法合理解释该行为时。', '本平台将有权选择暂时或永久限制OTC交易、限制提币或冻结账户等某项或多项措施。'],
  table_3_td_5: [
    '5',
    '接收或引入来源不合法的数字资产或资金：当用户明知或据合理常识判断可推知在其他平台/微信群收到的币为黑币或资金为黑钱时，但仍无视风险并直接将该黑币/黑钱流入到本平台其它用户的账户。',
    '本平台将直接永久限制此类用户的账户及关联账户全部功能。',
  ],
  table_3_td_6: ['6', '被认定洗钱的用户：当用户被风控系统检测或风控工作人员核实，用户直接参与或协助洗黑钱等犯罪行为。', '本平台将直接永久限制此类用户的账户及关联账户全部功能。'],
  table_3_td_7: [
    '7',
