...
export default {
  // U88 ASIA Rule
  agreement_title: 'U88 Asia法幣區交易規則',
  agreement_rule: '法幣區交易基本原則：',
  agreement_rule_list: [
    '本規則自發布之日起正式實施，並將不時予以修改或完善，修改或完善後的新規則自公布之日起即生效。',
    '如您不同意本規則及修改或完善後的規則內容，請立即停止使用平臺服務。',
    '如您繼續使用平臺服務的，視為您完全理解並接受本規則及不時修改或完善後的規則內容，並自願受其約束。',
  ],
  ...
  agreement_buy_rule_list: [
    ...
    '如買家下單後需要賣家必須完成平臺之外的KYC，請在對方下單後30分鐘內積極聯繫對方並完成KYC',
  ...
  agreement_sell_rule_list: ['提供經平臺認證的收款帳戶', '收到買方全額付款後，在訂單規定時間內完成放行', '非經買方同意，不得要求買家/客服取消訂單', '非經買方同意，不得對已創建的訂單價格提出異議'],

  // User Rule
  user_rule: '用戶應遵守反洗錢原則：',
  user_rule_list: [
    '用戶應遵守平臺的《U88 ASIA 條款和條件》並嚴格照此履行相關義務',
    '用戶應嚴格遵循平臺對用戶身份及帳戶的實名認證管理要求，確保在平臺上顯示的相關帳號均系本人合法註冊、使用',
    '用戶在觸發平臺的反洗錢風控預警時，應積極配合平臺的進一步反洗錢核實工作，並積極協助提供相關的風控舉證材料（具體措施以屆時平臺風控審核要求為準）',
  ],
  ...
  // Table #1 Td
  table_1_td_1: ['1', '訂單創建後，買方主動取消訂單，或著因付款超時而系統自動取消訂單。', '當日達到4次，系統將限制買方買入功能；連續2日觸發，系統將進一步限制買方賬戶部分功能。'],
  table_1_td_2: [
    '2',
    '未付款的情況下，點擊“我已付款。',
    '賣方有權要求取消此筆訂單，買方當日被投訴達到2次，系統將限制買方賬戶部分功能；此類投訴單筆金額超過8萬人民幣的，系統將直接限制買方賬戶48小時。',
  ],
  table_1_td_3: ['3', '賣方無違規，買方未付款的情況下，無故點擊“申訴”。', '賣方有權要求取消此筆訂單，買方當日被投訴達到2次，系統將限制買方賬戶部分功能；'],
  table_1_td_4: ['4', '未按照賣方訂單詳情頁面顯示的收款賬戶進行付款。', '賣家有權要求取消訂單，數字資產歸還給賣方，買方自行承擔轉錯款的風險。'],
  table_1_td_5: [
    '5',
  ...
  table_2_td_2: ['2', '訂單生成後，對訂單價格有異議的。', '除經買方同意協商訂單價格外，訂單正常成交，賣方應在訂單規定時間內放行。'],
  table_2_td_3: [
    '3',
    '賣方所提供的收款賬戶出現異常。',
  ...
  table_2_td_5: [
    ...
    '向平台投訴。 2）賣方因此被投訴達到3次，系統將會永久限制賣方賬戶。買方選擇繼續成交，因此被投訴達到2次，系統將限制買方賬戶部分功能。',
  ],
  table_2_td_6: ['6', '賣方收取買方非平台實名一致的賬戶付款，未拒絕成交的。', '1）由此引發的風險，由賣方自行承擔。 2）因此而被投訴的，系統將限制賣方賬戶部分功能。'],
  table_2_td_7: [
    '7',
  ...
  table_2_ps: '注：OTC交易使用三方電話系統過程中如您主動挑起語言衝突，有辱罵、嘲諷或其他語言過激行為等情況，系統將限制您賬戶部分功能。',
  ...
  table_3_td_2: [
    '2',
    '當用戶被核實從U88 Asia OTC買幣去其他平台場外群售出以獲利等其他高危行為。',
  ...
  table_3_td_4: ['4', '利用平台其他用戶測卡：用戶在訂單未發生的情況下向平台其他用戶小額打款，且無法合理解釋該行為時。', '本平台將有權選擇暫時或永久限制OTC交易、限制提幣或凍結賬戶等某項或多項措施。'],
  table_3_td_5: [
    '5',
    '接收或引入來源不合法的數字資產或資金：當用戶明知或據合理常識判斷可推知在其他平台/微信群收到的幣為黑幣或資金為黑錢時，但仍無視風險並直接將該黑幣/黑錢流入到本平台其它用戶的賬戶。',
    '本平台將直接永久限制此類用戶的賬戶及關聯賬戶全部功能。',
  ],
  table_3_td_6: ['6', '被認定洗錢的用戶：當用戶被風控系統檢測或風控工作人員核實，用戶直接參與或協助洗黑錢等犯罪行為。', '本平台將直接永久限制此類用戶的賬戶及關聯賬戶全部功能。'],
  table_3_td_7: [
    '7',
    '被司法凍結：當用戶賬戶被司法機構要求凍結時。',
    '本平台將嚴格按照司法機構出示的司法函件對用戶賬戶進行凍結。當凍結期滿，司法機構需出示續凍函方可繼續凍結。凍結期間，用戶向本平台申請解凍無效，請聯繫凍結機構協調。',
  ],
  table_3_td_8: ['8', '被司法調證：用戶被司法機構要求調取本平台賬戶資料，包括但不限於：司法調證、諮詢等形式。', '本平台將視情況限制此類用戶的賬戶及關聯賬戶的部分功能。'],
