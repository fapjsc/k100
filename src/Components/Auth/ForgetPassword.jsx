                ...
                <Form.Row className="mx-auto justify-content-center">
                  <Form.Group as={Col} xl={12} className="">
                    <Button
                      ...
                      style={{
                        cursor:
                          phoneValid || showNewPw ? "not-allowed" : "pointer",
                        backgroundColor:
                          phoneValid || showNewPw ? "grey" : "#3e80f9",
                      }}
                    >
                      {t("btn_continue")}
                    </Button>
                      ...
                      {isSendValidCode && expiredTime ? (
                        ...
                        <>
                          ...
                          >
                            ...
                            {!isLoading ? (
                              <span>{t("btn_send_valid_code")}</span>
                            ) : (
                  ...
                  <Form.Row className="mx-auto justify-content-between">
                    ...
                    <Form.Group as={Col} className="" xl={12}>
                      <Button
                        ...
                        className="w-100 h-100 easy-btn-bs"
                      >
                        {t("btn_confirm")}
                      </Button>
                    </Form.Group>
